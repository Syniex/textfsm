...
class TerminalTest(unittest.TestCase):
    ...
    def testAnsiText(self):
        self.assertEqual("\033[0mhello world\033[0m", terminal.AnsiText("hello world"))
        self.assertEqual(
            "\033[31mhello world\033[0m", terminal.AnsiText("hello world", ["red"])
        )
        self.assertEqual(
            "\033[31;46mhello world",
            terminal.AnsiText("hello world", ["red", "bg_cyan"], False),
        )
    ...
    def testIssue1(self):
        ...
        text1 = terminal.LineWrap(
            "\033[32m" + "boembabies, " * 10 + "boembabies" + "\033[0m", omit_sgr=True
        )
        text2 = (
            "\033[32m"
