...
class UnitTestFSM(unittest.TestCase):
    ...
    def testFSMValue(self):
        ...
        self.assertRaises(textfsm.TextFSMTemplateError, v.Parse, "Value beer (boo)hoo)")
    ...
    def testInvalidStates(self):
        ...
        self.assertRaises(
            textfsm.TextFSMTemplateError, textfsm.TextFSMRule, "^.* -> Continue Start"
        )
    ...
    def testParseTextToDicts(self):
        ...
        data = "Matching text\nAnd again"
        result = t.ParseTextToDicts(data)
        self.assertListEqual(result, [{"boo": "Matching text"}, {"boo": "And again"}])
